...
class PI0Pytorch(nn.Module):
    ...
    @torch.no_grad()
    def sample_actions(self, device, observation, mode="train", noise=None, num_steps=10, compute_values=True) -> Tensor:
        ...
        (prefix_output, suffix_output), past_key_values = self.paligemma_with_expert.forward(
